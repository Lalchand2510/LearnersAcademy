...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/LearnersAcademy'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/LearnersAcademy/Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<%} else{
response.sendRedirect("/LearnersAcademy/Dashboard.jsp");
%>
